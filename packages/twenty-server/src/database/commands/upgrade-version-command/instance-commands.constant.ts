...
import { AddDharmaExpenseDueAtFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-5/2-5-instance-command-fast-1779700000000-add-dharma-expense-due-at';
...
export const INSTANCE_COMMANDS = [
  ...
  AddDharmaExpenseDueAtFastInstanceCommand,
];
