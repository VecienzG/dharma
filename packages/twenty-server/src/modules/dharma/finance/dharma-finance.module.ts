...
import { DharmaIncomeEntrySplitListener } from 'src/modules/dharma/finance/listeners/dharma-income-entry-split.listener';
...
@Module({
  ...
  providers: [
    DharmaSplitEngineService,
    DharmaFinanceKpiService,
    DharmaIncomeEntrySplitListener,
  ],
