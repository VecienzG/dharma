...
// Token strings generated by NestJS for InjectRepository(Entity, 'core').
// NestJS derives the token from the TypeScript class name, not the @Entity name option.
const USER_REPO_TOKEN = 'core_UserEntityRepository';
const WORKSPACE_REPO_TOKEN = 'core_WorkspaceEntityRepository';
